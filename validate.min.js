...
(function (r, t, l) {
  var u = {
      ...
      default: "El campo %s todavía está configurado como predeterminado, cámbielo.",
      ...
      alpha: "El campo %s solo debe contener caracteres alfabéticos.",
      alpha_numeric: "El campo %s solo debe contener caracteres alfanuméricos.",
      alpha_dash: "El campo %s solo debe contener caracteres alfanuméricos, guiones bajos y guiones.",
      ...
      is_natural: "El campo %s debe contener solo números positivos.",
      ...
      is_file_type: "El campo %s debe contener solo %s archivos.",
      valid_url: "El campo %s debe contener una URL válida.",
      greater_than_date: "El campo %s debe contener una fecha más reciente que %s.",
      ...
      less_than_or_equal_date: "El campo %s debe contener una fecha que sea %s o anterior.",
    },
    v = function (a) {},
    w = /^(.+?)\[(.+)\]$/,
    g = /^[0-9]+$/,
    ...
    f = function (a, c, b) {
      ...
      for (b = c.length; a < b; a++) {
        ...
        if ((d.name || d.names) && d.rules)
          ...
          console.warn(
            "validar.js: el siguiente campo se está omitiendo debido a una configuración incorrecta:"
          ),
            console.warn(d),
            console.warn(
              "Verifique que haya configurado correctamente un nombre y reglas para este campo"
            );
      }
